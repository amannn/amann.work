  ...
  return (
    <Page>
        ...
        <Wrapper>
          <ResponsiveGrid>
            <ServicesItem title="React apps">
              With 10 years of experience with web apps and 5 years of React, I
              can help you architect and build ambitious web experiences that
      ...
      <Section title="Selected projects">
        <Projects
          showMoreButton={<Button color="accent">Show more projects</Button>}
        >
          <Project
            cta={
          ...
          >
            <ProjectParagraph>
              ...
              , setlist.fm is one of the most popular music services worldwide
              and enables its users to share their knowledge about concert
              setlists. The team from{' '}
              <ProjectAnchor href="http://molindo.at">Molindo</ProjectAnchor>{' '}
              set out to relaunch the core experience of adding and editing
              setlists and hired me to implement the user interface.
            </ProjectParagraph>
            <ProjectParagraph>
              The frontend of the project consists of four React widgets. These
              integrate seamlessly with the existing web stack of the platform
              and communicate with a GraphQL API. To live up to the high
              expectations of mobile apps, the implementation places special
              focus on touch gestures, useful animations, runtime performance
              and an offline-first approach to data.
            </ProjectParagraph>
          </Project>
          <Project
            cta={
          ...
          >
            <ProjectParagraph>
              ...
              navigation systems that are used by manufacturers such as BMW,
              Audi, Mercedes & many more. The company counts more than 13,000
              employees and wanted to take their data management apps to the
              next level by utilising a React-based component library that can
              be composed in flexible ways.
            </ProjectParagraph>
            <ProjectParagraph>
          ...
          >
            <ProjectParagraph>
              ...
              app which digitally depicts the process from making a reservation
              to unlocking a car.
            </ProjectParagraph>
            <ProjectParagraph>
